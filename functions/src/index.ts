...
export const withdrawV2 = onRequest(async (request, response) => {
...
const publishTrasaction = (wdRequest: WithdrawRequest) => {
  ...
  //     Message: JSON.stringify(wdRequest),
  //     TopicArn: "arn:aws:sns:af-south-1:157086621404:transaction",
  //   };

  //   sns.publish(params, (err, data) => {
  //     if (err) {
  //       success = false;
  //       logger.error("Failed to Send message due to", err);
  //       return;
  //     }
